        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <form role="form" method="post" action="pages/kategori/kategorihapus_proses.php">
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-danger" title="Hapus Data"> <i class="fa fa-refresh"></i>Hapus</button>
                                </div>
                            </form>
