        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card">
              ...
              <form role="form" method="post" action="pages/tiket/tiketupdate_proses.php">
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-success" title="Simpan Data"> <i class="fa fa-update"></i> Update</button>
                                </div>
                            </form>
