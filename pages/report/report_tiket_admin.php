                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                FROM
                                    ...
                                    users
                                    ON 
                                        tiket.username = users.username WHERE tiket.tanggal >= '$tanggalawal' and tiket.tanggal <= '$tanggalakhir'");
...
<script type="text/javascript">
    ...
    function tampilkan() {
        ...
        window.location = "./index.php?page=report_tiket_admin&tanggalawal=" + sdate + "&tanggalakhir=" + edate + "";
    }
